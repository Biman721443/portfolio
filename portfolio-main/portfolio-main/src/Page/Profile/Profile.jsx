            ...
            <div className="socialicon mb-5 lg:mb-10">
                <div className=" flex justify-center items-center gap-2 xl:gap-4">
                    ...
                    <div className=" ">
                        <Link
                            target='_blank'
                            to={"https://github.com/Biman721443"}
                    ...
                    <div className=" ">
                        <Link
                            target='_blank'
                            to={"https://www.linkedin.com/in/biman-gharai/"}
                ...
                <div>
                        ...
                        <div className="flex justify-center items-start flex-col">
                            ...
                            <p className="dark:text-white">
                                <Link to="tel:+8801318021256"
                                    className="hover:text-[#FA5252] text-lg xl:text-[20px] transition-all duration-500">+917365818084</Link>
                            </p>
                        </div>
                    </div>
                    ...
                    <div
                        ...
                        <div className="flex justify-center items-start flex-col">
                            ...
                            <p className="dark:text-white">
                                <span className=" text-lg xl:text-[20px] ">Kolkata, India</span>
                            </p>
                        </div>
                    </div>
                        ...
                        <div className="flex justify-center items-start flex-col">
                            ...
                            <p className="dark:text-white">
                                <Link to="mailto:taskinahmadalfaruqe@gmail.com"
                                    className="hover:text-[#FA5252] text-[14px] xl:-[16px] 2xl:text-[20px] transition-all duration-500">bimangharai721443@gmail.com</Link>
                            </p>
                        </div>
                    </div>
                    <div
                        ...
                        <div className="flex justify-center items-start flex-col">
                            ...
                            <p className="dark:text-white">
                                <a className=" text-lg xl:text-[20px]">Augest 01, 2000</a>
                            </p>
                        </div>
                    </div>
                </div>
