        ...
        <div className="home bg-whiteColor dark:bg-darkbg rounded-t-xl">
            <div className="p-3 pb-0 lg:p-7">
                ...
                <p className="text-[15px] leading-7">
                    <span className="mb-2 lg:mb-3 block">Hello, I’m Biman Gharai, a passionate Web Developer from Kolkata, India. I hold a Bachelor’s degree in Computer Applications (BCA), which laid the foundation for my journey in technology and development.

After completing my graduation, I started my career at Netscribes, where I worked as part of the Flipkart Fraud Risk Management team. This role helped me develop problem-solving skills and a strong focus on detail.

To further advance my career, I joined Masai School, where I honed my skills in full-stack web development.
                    </span>
                    <span className=" mb-3 lg:mb-10 block">I am writing to express my keen interest with a year of learning skills experience in web development, I excel in technologies like HTML, CSS, JavaScript, React, Node, MongoDB, Tailwind CSS, Bootstrap, MetarialUI, Metarail Tailwind, Firebase Authentication, etc.</span>
                        ...
                        <ul
                            ...
                            <li
                                ...
                                <div className="text">
                                    ...
                                    <p className=" text-[17px] pb-2 m-0 leading-8">Web development merges code (HTML, CSS, JavaScript,React Js) to build and maintain websites and applications. Front-end concerns user interface; back-end manages servers and databases. It encompasses both design and functionality on the internet.</p>
                                </div>
                            </li>
