                    ...
                    <div className="col-span-12 grid lg:grid-cols-2 gap-4">
                        <div className="Education">
                            ...
                            <div className="items">
                                <div
                                    ...
                                    <span
                                        className="text-tiny text-gray-lite dark:text-[#b7b7b7]">2018-2021</span>
                                    <h3 className="text-xl dark:text-white">Bachelor of Computer Applications</h3>
                                    <p className="dark:text-[#b7b7b7]">Makaut University</p>
                                </div>

                                <div
                                    className="py-4 pl-5 pr-3 space-y-2 mb-6 rounded-lg dark:border-[#212425] dark:border-2 bg-[#fff4f4] dark:bg-transparent">
                                    <span className="text-tiny text-gray-lite dark:text-[#b7b7b7]">2018</span>
                                    <h3 className="text-xl dark:text-white">Higher Secondery School Certificate</h3>
                                    <p className="dark:text-[#b7b7b7]">Garh Haripur G.N High School, Medinipur</p>
                                </div>
                            </div>
                        </div>
                        <div className="Experence">
                            ...
                            <div
                                ...
                                <span className="text-tiny text-gray-lite dark:text-[#b7b7b7]">2024</span>
                                <h3 className="text-xl dark:text-white">WEB Development</h3>
                                <p className="dark:text-[#b7b7b7]">Masai School, Bengaluru
                                </p>
                            </div>
